...
<html lang="en">
  ...
  <body>
      <form action="{{ URL::to('communication/update') }}" method="post">
      @csrf
    <div class="container">
        ...
        <div class="form-group">
          ...
          value="{{$communication->communication_id}}" aria-describedby="helpId">
        ...
        <div class="form-group">
          ...
          value="{{$communication->staff_id}}"  aria-describedby="helpId">
          <span class="text-danger">
            @error('staff_id')
            {{$message}}
            @enderror
        ...
        <div class="form-group">
            ...
            value="{{$communication->message}}"   aria-describedby="helpId"></textarea>
            <span class="text-danger">
                @error('message')
                {{$message}}
                @enderror
        ...
        value="{{$communication->notification}}"  aria-describedby="notificationHelp">
        <span class="text-danger">
            @error('notification')
            {{$message}}
            @enderror
        ...
        <div class="form-group">
          ...
          value="{{$communication->meeting_schedule}}"   aria-describedby="helpId">
          <span class="text-danger">
        ...
        <input type="hidden" name="update_id" value="{{$communication->communication_id}}">
