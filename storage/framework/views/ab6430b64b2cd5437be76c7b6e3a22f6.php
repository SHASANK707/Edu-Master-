...
<?php $__env->startSection('content'); ?>
    <div class="container">
        ...
        <form id="faculty-form" method="POST" action="<?php echo e(URL::to('/faculty_dashboard/update')); ?>" onsubmit="return confirmUpdate()">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="faculty_contact" name="faculty_contact" value="<?php echo e($faculty->faculty_contact); ?>" placeholder="Enter Faculty Contact No" required>
...
<?php echo $__env->make('index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\example-12\resources\views\facultylogininfoupdate.blade.php ENDPATH**/ ?>