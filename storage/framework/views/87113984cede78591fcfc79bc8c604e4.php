    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                <?php if(Auth::user()->role === 'Student'): ?>
                    <li class="active">
                        ...
                        <ul class="collapse list-unstyled" id="studentSubmenu">
                            <li><a href="<?php echo e(url('/student_dashboard')); ?>"
                ...
                <?php if(Auth::user()->role === 'Institute'): ?>
                    <li>
                        ...
                        <ul class="collapse list-unstyled" id="instituteSubmenu">
                            <li><a href="<?php echo e(url('/institute/instituteshow')); ?>"
                                    onclick="displayInfo('institute', 'view institute')">View Institute</a></li>
                            <li><a href="<?php echo e(url('/course/courseview')); ?>"
                ...
                <?php if(Auth::user()->role === 'Faculty'): ?>
                    <li class="active">
                        ...
                        <ul class="collapse list-unstyled" id="teacherSubmenu">
                            <li><a href="<?php echo e(url('/faculty_dashboard')); ?>" onclick="displayInfo('teacher', 'classes')">Show
                                    Info</a></li>
                            <li><a href="<?php echo e(url('/faculty_dashboard/showstudent')); ?>"
                ...
                <?php if(Auth::user()->role === 'Management'): ?>
                    <li>
                        ...
                        <ul class="collapse list-unstyled" id="managementSubmenu">
                            <li><a href="<?php echo e(url('/student/view')); ?>"
                                    onclick="displayInfo('student', 'add_student')">Student</a></li>
                            <li><a href="<?php echo e(url('/staff/form/view')); ?>"
                                    onclick="displayInfo('management', 'add_staff')">Staff</a></li>
                            <li><a href="<?php echo e(url('/clss/view')); ?>" onclick="displayInfo('management', 'add_class')">Class</a>
                            </li>
                            <li><a href="<?php echo e(url('/faculty/show')); ?>"
                                    onclick="displayInfo('management', 'add_faculty')">Faculty</a></li>
                            <li><a href="<?php echo e(url('/parent/show')); ?>" onclick="displayInfo('parents', 'children')">Parent</a>
                            </li>
                        </ul>
                    </li>
                <?php endif; ?>

                <?php if(Auth::user()->role === 'Parents'): ?>
                    <li>
                        <a href="#parentsSubmenu" data-toggle="collapse" aria-expanded="false"
                            class="dropdown-toggle">Parents</a>
                        <ul class="collapse list-unstyled" id="parentsSubmenu">
                            <li><a href="<?php echo e(url('/parentdashboard')); ?>"
...
</html><?php /**PATH C:\xampp\htdocs\example-12\resources\views\index.blade.php ENDPATH**/ ?>