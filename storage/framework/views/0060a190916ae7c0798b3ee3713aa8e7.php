...
<?php $__env->startSection('content'); ?>
    <div class="container">
        ...
        <form id="update-form" action="<?php echo e(URL::to('/student_dashboard/updatestudent')); ?>" method="post">
            <?php echo csrf_field(); ?>
            <div class="form-row">
...
<?php echo $__env->make('index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\example-12\resources\views\studentloginEdit.blade.php ENDPATH**/ ?>