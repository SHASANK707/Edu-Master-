...
<body>
    ...
    <div class="container">
        ...
        <a class="button" href="<?php echo e(URL::to('/studentTimetable/show')); ?>">Show StudentTimetable </a>
        ...
        <form method="post" action=" <?php echo e(route('timetable.store')); ?>">
            <?php echo csrf_field(); ?>
            <div class="form-group">
                ...
                <?php $__errorArgs = ['stud_timetable'];
...
<?php /**PATH C:\xampp\htdocs\example-12\resources\views\studentTimetable.blade.php ENDPATH**/ ?>