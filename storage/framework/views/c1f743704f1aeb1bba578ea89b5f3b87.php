<?php $__env->startSection('content'); ?>
    <div class="container">
        <h1>Edit Details</h1>
        <form id="editForm" action="<?php echo e(URL::to('/parent/update')); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\example-12\resources\views\parentinfoupdate.blade.php ENDPATH**/ ?>